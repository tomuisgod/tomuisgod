...
### 💻 | Projects 
---
`0.1` <a href="https://github.com/tomuisgod/SEN3-GCM"> SEN3 ANSWERS  </a>- Answers to all works on SEN seminars level 3 in Python (Senior year)
<br>`0.1` <a href="https://github.com/tomuisgod/SEN2-GCM">SEN2 ANSWERS </a> - Answers to all works on SEN seminars level 2 in Python(Senior year)
